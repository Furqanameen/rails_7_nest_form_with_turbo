...
class LiveStreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create live_stream" do
    assert_difference("LiveStream.count") do
      post live_streams_url, params: { live_stream: { live_stream_product: @live_stream.live_stream_product, start_date: @live_stream.start_date, start_time: @live_stream.start_time, title: @live_stream.title } }
    end
  ...
  test "should update live_stream" do
    patch live_stream_url(@live_stream), params: { live_stream: { live_stream_product: @live_stream.live_stream_product, start_date: @live_stream.start_date, start_time: @live_stream.start_time, title: @live_stream.title } }
